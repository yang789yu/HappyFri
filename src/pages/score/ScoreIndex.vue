<template>
    <div>
        ...
        <div class="share_code">
            ...
            <!-- img 元素的属性 height width 必须用不带单位的数字。但在 css 中需要单位 -->
            <img src="../../assets/images/4-4.png" alt="QR code" height="212" width="212" class="code_img">
        </div>
        <div class="share_cover" v-show="showHide" @click="showCover">
            <img src="../../assets/images/5-2.png" alt="share" class="share_img">
        </div>
        <h1>总共用时{{ allTime }}</h1>
    </div>
</template>
...
export default {
    ...
    computed:{
        ...mapState(['answerIdArray','allTime']),
    },
    methods:{
        // 计算分数
        computeScore(){
            this.answerIdArray.forEach((item, index) => {
    ...
    created(){
        this.computeScore();
        this.getScoreTip();
        // document.body.style.backgroundImage = 'url(../../assets/images/4-1.jpg)'
    }
}
</script>
